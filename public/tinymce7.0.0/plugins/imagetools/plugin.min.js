...
!(function() {
  ...
  function Y(e) {
    ...
    var n = e.style.width,
      r = e.style.height
    return n || r ? (t(n) && t(r) ? { w: parseInt(n, 10), h: parseInt(r, 10) } : null) : ((n = e.width), (r = e.height), n && r ? { w: parseInt(n, 10), h: parseInt(r, 10) } : null)
  }
  function Z(e) {
  ...
  function fe(u, c, s, f, l, d, m) {
    return s.toBlob().then(function(e) {
      var t,
        ...
        a = c.type === e.type
      return (
        u.getParam('images_reuse_filename', !1, 'boolean') && (n = h((o = r.getByUri(i))) ? ((i = o.uri()), (t = o.name()), o.filename()) : ((t = ae(u, i, 2)), ae(u, i, 1))),
                      ...
                      M((c = o))
                        .then(function(e) {
                          var t,
                            ...
                            i = Z(e)
                          return (
                            (u.w === i.w && u.h === i.h) || (Y(a) && ((t = a), (n = i) && ((r = t.style.width), (o = t.style.height), (r || o) && ((t.style.width = n.w + 'px'), (t.style.height = n.h + 'px'), t.removeAttribute('data-mce-style')), (r = t.width), (o = t.height), (r || o) && (t.setAttribute('width', String(n.w)), t.setAttribute('height', String(n.h)))))), URL.revokeObjectURL(e.src), c
                          )
                        })
                        .then(W)
                        .then(function(e) {
  ...
  o.add('imagetools', function(e) {
    var t,
      ...
      a = c(null),
      u = e
    f.each({ mceImageRotateLeft: de(u, n, -90), mceImageRotateRight: de(u, n, 90), mceImageFlipVertical: me(u, n, 'v'), mceImageFlipHorizontal: me(u, n, 'h'), mceEditImage: he(u, n) }, function(e, t) {
      u.addCommand(t, e)
    }),
      ge(e),
